...
class SarsaAgent(Agent[SarsaTrainingParams, SarsaTrainingResults, State, Action]):
    qvals: FloatArr
    ...
    @override
    def train(self, params: SarsaTrainingParams) -> SarsaTrainingResults:
        ...
        return SarsaTrainingResults(steps_pe, t_reward_pe)
